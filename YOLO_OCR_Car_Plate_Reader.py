...
reader = easyocr.Reader(['en'] , gpu= False, model_storage_directory= 'import')
model = YOLO('yolo11n.pt', task = 'detect')
cap = cv2.VideoCapture('cartraffic02.mp4')
